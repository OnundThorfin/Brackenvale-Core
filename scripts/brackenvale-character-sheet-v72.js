...
console.info("Brackenvale Core character sheet runtime: 0.5.4-test.72");
const TEMPLATE_PATH =
    ...
    _activateCalibrationControls(root) {
      ...
      root.addEventListener("pointerdown", (event) => {
        ...
        const field = event.target.closest(
          ".brackenvale-page-fields .overlay-field, .brackenvale-page2-dom .overlay-field[data-component-key], .brackenvale-page2-dom .overlay-field[data-component-key]"
        );
